...
//        CHK_ERR(DDERR_INVALIDPARAMS, "DDERR_INVALIDPARAMS")
    ...
    CHK_ERR(DDERR_NOCOLORCONVHW, "Operation could not be carried out because there is no Colour conversion hardware present or available.")
    ...
    CHK_ERR(DDERR_NOCOLORKEY, "Surface doesn't currently have a Colour key")
    CHK_ERR(DDERR_NOCOLORKEYHW, "Operation could not be carried out because there is no hardware support of the dest Colour key.")
    ...
    CHK_ERR(DDERR_NOT4BITCOLOR, "DirectDrawSurface is not in 4 bit Colour palette and the requested operation requires 4 bit Colour palette.")
    CHK_ERR(DDERR_NOT4BITCOLORINDEX, "DirectDrawSurface is not in 4 bit Colour index palette and the requested operation requires 4 bit Colour index palette.")
    CHK_ERR(DDERR_NOT8BITCOLOR, "DirectDraw Surface is not in 8 bit Colour mode and the requested operation requires 8 bit Colour.")
...
//        CHK_ERR(DDERR_OUTOFVIDEOMEMORY, "DDERR_OUTOFVIDEOMEMORY")
    ...
    CHK_ERR(DDERR_OVERLAYCOLORKEYONLYONEACTIVE, "Can only have ony Colour key active at one time for overlays")
    ...
    CHK_ERR(DDERR_COLORKEYNOTSET, "No src Colour key specified for this operation.")
...
//        CHK_ERR(DDERR_UNSUPPORTED, "DDERR_UNSUPPORTED")
    ...
    CHK_ERR(DDERR_NOPALETTEHW, "No hardware support for 16 or 256 Colour palettes.")
...
//      CHK_ERR(D3D_OK, "Ok")
    ...
    CHK_ERR(D3DERR_UNSUPPORTEDCOLOROPERATION, "Unsupported Colour operation")
    CHK_ERR(D3DERR_UNSUPPORTEDCOLORARG, "Unsupported Colour arg")
